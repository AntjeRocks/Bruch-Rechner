...
public class BruchController {
    ...
    public void los() {
        final Bruch bruch1 = new Bruch(Integer.parseInt(ganzzahl1.getText()), (Integer.parseInt(zaehler1.getText())), (Integer.parseInt(nenner1.getText())));
        final Bruch bruch2 = new Bruch(Integer.parseInt(ganzzahl2.getText()), (Integer.parseInt(zaehler2.getText())), (Integer.parseInt(nenner2.getText())));
        switch (operator) {
            case "+":
